...
%% API
-export([start_link/0, register_pid/3, unregister_pid/3, get_pid/2]).
...
unregister_pid(RegistryServerRef, PidToUnregister, PidKey) ->
  gen_server:cast(RegistryServerRef, {unregister, {PidToUnregister, PidKey}}).
